...
class CircleChanger(object):
    ...
    def __init__(self, x, y, radius, fill_color, colors):
        ...
        self.color1 = self.circle.fill_color
    ...
    def swell_or_shrink_repeatedly(self,
        ...
        for _ in range(times_to_swell_or_shrink + 1):
    ...
    def swallow(self, other_circle_changer):
        ...
        point = other_circle_changer.circle.center
        d = self.circle.center.get_distance_from(point)
        new_point = rg.Point(point.x, point.y)
        new_point.move_by((self.circle.center.x - point.x) / 2, (self.circle.center.y - point.y) / 2)

        new_cc = CircleChanger(new_point.x, new_point.y, d / 2, 'red', self.colors + other_circle_changer.colors)
    ...
    def change_to_original_color(self):
        ...
        self.circle.fill_color = self.color1
    ...
    def change_to_next_color_in_tuple(self):
        ...
        for k in range(len(self.colors)):
            self.circle.fill_color = self.colors[(k + 1) % 1]
